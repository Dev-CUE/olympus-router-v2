> ⚠️ **아카이브 — 현행 아님 (v6.10 시점, 2026-06-10).**
>
> 이 문서는 **하위 문서 v6.10 정합화 작업용 구 핸드오프**입니다. 현행 진입점이 아닙니다.
> **새 세션은 `HANDOFF.md`(단일 진입점)부터 읽으세요.** 현재 위치·역할·다음 할 일은 거기에 있습니다.
> 이 파일은 v6.10 작업 맥락 보존용으로만 남깁니다. 갱신하지 않습니다.
>
> 문서 지도: HANDOFF.md(진입점) / Olympus_Session_Protocol.md(방법) / Olympus_Design_Ledger.md(설계 누적) / Olympus_PRD_Plan.md(SSOT).
